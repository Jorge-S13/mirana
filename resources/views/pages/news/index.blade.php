                            ...
                            <div class="product-item bg-blue-trans p-3 rounded-1 mb-3 ">
                                <div class="product-detail">
                                    <div class="clients-detail">
                                        <a href="{{route('news.show',$post->slug)}}"> <img src="{{asset('storage/' . $post->main_image)}}" alt="{{$post->image_alt}}"> </a>
                                    </div>
                                    <div class="btn-card">
                                        <a href="{{route('news.categories',$post->category->slug)}}" class="view-btn">{{$post->category_name}}</a>
                                    </div>
